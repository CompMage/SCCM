...
Name = "File-Services" 
Ensure = "Present" 
DependsOn = @("[WindowsFeature]File and Storage Services") 
}
...
Name = "FS-FileServer" 
Ensure = "Present" 
DependsOn = @("[WindowsFeature]Depend") 
}

WindowsFeature "Storage Services" 
{ Name = "Storage-Services" Ensure = "Present" DependsOn = @("[WindowsFeature]Depend") }

WindowsFeature "Web Server (IIS)" 
{ Name = "Web-Server" Ensure = "Present" DependsOn = @("[WindowsFeature]Depend") }

WindowsFeature "Web Server" 
{ Name = "Web-WebServer" Ensure = "Present" DependsOn = @("[WindowsFeature]Depend") }
